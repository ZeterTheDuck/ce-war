...
public class GameCard implements Comparable<GameCard> {
    ...
    /**
     * Unordered map of all cards attached to this card. 
     * 
     * <p> Cards are mapped by their {@link #ucid}
     */
    @Getter @Setter
    private HashMap<Long, GameCard> attachedCards;

    /**
     * Whether this card should display as upside-down. Used in-game to signify that the owner is
     * different.
     * 
    ...
    /**
     * Whether this card should be visible to the opponent. Used primarily for the player's hand
     * and action slots.
     * 
     * <p> This is not secure, as the opponent can check the JSON data of game updates.
     * 
     * <p> Cards in the (main) deck are always invisible, and cards in the GY and Dump are always
     * visible.
     */
    @Getter @Setter
    ...
    /**
     * Map of counters attached to this card. 
     * 
     * <p> The key of an entry is the name of the counter, i.e. "Time"
     * 
     * <p> The value of an entry is the number of counters for that key
     */
    @Getter
    ...
    /**
     * Sets the corresponding number of counters attached to this card
     * 
     ...
     * 
     * @return the topmost card that this card is stacked to, or this card if it is the topmost in
     * the stack
     */
     ...
     * 
     * <p> Resets counter, health, attack, etc., and changes location and position to match other
     * card.
     * 
